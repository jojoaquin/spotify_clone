...
const config = {
  ...
  "inlineSchemaHash": "7c27532df74ba4d75ebe372043b670e2473493c2e9dbd33c378724c2952687fc",
  "copyEngine": true
}
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "prisma/generated/prisma-dev",
    "generated/prisma-dev",
  ]
...
path.join(process.cwd(), "prisma/generated/prisma-dev/libquery_engine-darwin-arm64.dylib.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "prisma/generated/prisma-dev/schema.prisma")
